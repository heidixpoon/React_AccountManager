...
public class UserServiceException extends QueenHeadException {
    protected static final String ERROR_CODE_PREFIX = "USR";

    public UserServiceException(HttpStatus httpStatus, String errorCode, String message) {
