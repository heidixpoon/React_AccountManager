...
public class UserEmptyException extends CompensationServiceException {
    private static final String ERROR_CODE = ERROR_CODE_PREFIX + "007";
    private static final String ERROR_MESSAGE = "User cannot be empty or null.";
