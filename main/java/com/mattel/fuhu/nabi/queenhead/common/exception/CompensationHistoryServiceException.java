...
public class CompensationHistoryServiceException extends QueenHeadException{
    protected static final String ERROR_CODE_PREFIX = "CMH";

    public CompensationHistoryServiceException(HttpStatus httpStatus, String errorCode, String message) {
