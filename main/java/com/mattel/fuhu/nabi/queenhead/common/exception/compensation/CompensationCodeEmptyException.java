...
public class CompensationCodeEmptyException extends CompensationServiceException {
    private static final String ERROR_CODE = ERROR_CODE_PREFIX + "001";
    private static final String ERROR_MESSAGE = "Compensation code cannot be null or empty.";
    private static final HttpStatus HTTP_STATUS = HttpStatus.BAD_REQUEST;

    public CompensationCodeEmptyException() {
