...
public class CancelReasonEmptyException extends CompensationServiceException {
    private static final String ERROR_CODE = ERROR_CODE_PREFIX + "003";
    private static final String ERROR_MESSAGE = "Cancel reason cannot be null or empty.";
    private static final HttpStatus HTTP_STATUS = HttpStatus.BAD_REQUEST;

    public CancelReasonEmptyException() {
