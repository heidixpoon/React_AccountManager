...
public class ReportServiceException extends QueenHeadException {
    protected static final String ERROR_CODE_PREFIX = "REP";

    public ReportServiceException(HttpStatus httpStatus, String errorCode, String message) {
