...
public class CustomerServiceException extends QueenHeadException {
    protected static final String ERROR_CODE_PREFIX = "CSM";

    public CustomerServiceException(HttpStatus httpStatus, String errorCode, String message) {
