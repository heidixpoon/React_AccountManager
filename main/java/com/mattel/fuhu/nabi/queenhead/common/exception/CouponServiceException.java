...
public class CouponServiceException extends QueenHeadException {
    protected static final String ERROR_CODE_PREFIX = "COU";

    public CouponServiceException(HttpStatus httpStatus, String errorCode, String message) {
